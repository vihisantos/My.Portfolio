import{j as r}from"./ui-BpQ-T0JO.js";import{C as e}from"./UILibrary-DHVl_TGJ.js";import"./vendor-BZTSXe9S.js";import"./index-B-iZa3N5.js";import"./framer-DCobejFE.js";import"./SEO-yt4J-mc4.js";import"./Navigation-D_TMajI5.js";import"./input-B5WnmuMM.js";import"./index-C8pce-KX.js";const a=`import React from 'react';
...
`;function m(){return r.jsx(e,{title:"Galaxy Button",code:a,className:"flex items-center justify-center p-12",children:r.jsxs("div",{className:"galaxy-button-wrapper",children:[r.jsx("style",{children:`
        .uiverse {
          --duration: 7s;
          --easing: linear;
          --c-color-1: rgba(255, 163, 26, 0.7);
        ...
        `}),r.jsx("button",{className:"uiverse",children:r.jsxs("div",{className:"wrapper",children:[r.jsx("span",{children:"Portfolio"}),r.jsx("div",{className:"circle circle-12"}),r.jsx("div",{className:"circle circle-11"}),r.jsx("div",{className:"circle circle-10"}),r.jsx("div",{className:"circle circle-9"}),r.jsx("div",{className:"circle circle-8"}),r.jsx("div",{className:"circle circle-7"}),r.jsx("div",{className:"circle circle-6"}),r.jsx("div",{className:"circle circle-5"}),r.jsx("div",{className:"circle circle-4"}),r.jsx("div",{className:"circle circle-3"}),r.jsx("div",{className:"circle circle-2"}),r.jsx("div",{className:"circle circle-1"})]})})]})})}function d(){return r.jsxs("div",{className:"galaxy-button-wrapper scale-[1.4]",children:[r.jsx("style",{children:`
        .uiverse {
          --duration: 7s; --easing: linear;
          --c-color-1: rgba(255, 163, 26, 0.7); --c-color-2: #1a23ff;
          --c-color-3: #e21bda; --c-color-4: rgba(255, 232, 26, 0.7);
          --c-shadow: rgba(255, 223, 87, 0.5);
          --c-shadow-inset-top: rgba(255, 223, 52, 0.9);
          --c-shadow-inset-bottom: rgba(255, 250, 215, 0.8);
          --c-radial-inner: #ffd215; --c-radial-outer: #fff172; --c-color: #fff;
          -webkit-tap-highlight-color: transparent; -webkit-appearance: none; outline: none;
          position: relative; cursor: pointer; border: none; display: table;
          border-radius: 24px; padding: 0; margin: 0; text-align: center;
          font-weight: 600; font-size: 16px; letter-spacing: 0.02em; line-height: 1.5;
          color: var(--c-color);
        ...
        .uiverse:before {
          ...
          left: 0; top: 0; right: 0; bottom: 0; border-radius: 24px;
          box-shadow: inset 0 3px 12px var(--c-shadow-inset-top), inset 0 -3px 4px var(--c-shadow-inset-bottom);
        }
        .uiverse .wrapper {
          -webkit-mask-image: -webkit-radial-gradient(white, black);
          overflow: hidden; border-radius: 24px; min-width: 132px; padding: 12px 0;
        }
        ...
        .uiverse .wrapper .circle {
          ...
          border-radius: 50%; filter: blur(var(--blur, 8px));
          background: var(--background, transparent);
          transform: translate(var(--x, 0), var(--y, 0)) translateZ(0);
          animation: var(--animation, none) var(--duration) var(--easing) infinite;
        }
        ...
        @keyframes circle-12 { 33% { transform: translate(56px, 0px) translateZ(0); } 66% { transform: translate(60px, -32px) translateZ(0); } }
            `}),r.jsx("button",{className:"uiverse",children:r.jsxs("div",{className:"wrapper",children:[r.jsx("span",{children:"Portfolio"}),r.jsx("div",{className:"circle circle-12"}),r.jsx("div",{className:"circle circle-11"}),r.jsx("div",{className:"circle circle-10"}),r.jsx("div",{className:"circle circle-9"}),r.jsx("div",{className:"circle circle-8"}),r.jsx("div",{className:"circle circle-7"}),r.jsx("div",{className:"circle circle-6"}),r.jsx("div",{className:"circle circle-5"}),r.jsx("div",{className:"circle circle-4"}),r.jsx("div",{className:"circle circle-3"}),r.jsx("div",{className:"circle circle-2"}),r.jsx("div",{className:"circle circle-1"})]})})]})}export{m as GalaxyButton,d as GalaxyButtonContent};
