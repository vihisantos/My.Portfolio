import{j as e,af as x}from"./ui-qcFD9uuN.js";import{H as f}from"./index-BEYwci-1.js";import{L as b}from"./vendor-BZTSXe9S.js";import"./framer-Bz8kBvrX.js";const g=`# Portfolio | Vitor.dev
...
`),r=[];let n=[],d=!1,c=[];const h=(t,a)=>{if(t.trim().startsWith("```")){d?(r.push(e.jsx("div",{className:"my-4 bg-zinc-900 text-zinc-100 p-4 rounded-lg overflow-x-auto font-mono text-sm shadow-inner border border-zinc-800",children:e.jsx("pre",{children:e.jsx("code",{children:c.join(`
`)})})},`code-${a}`)),c=[],d=!1):d=!0;return}if(d){c.push(t);return}const o=t.match(/!\[(.*?)\]\((.*?)\)/);if(o){let s=o[2];if(s.startsWith("public/")){const i=s.replace("public/","");s=`${"/My.Portfolio/".endsWith("/")?"/My.Portfolio/".slice(0,-1):"/My.Portfolio/"}${i.startsWith("/")?i:"/"+i}`}else!s.startsWith("http")&&!s.startsWith("/")&&(s="/"+s);r.push(e.jsxs("div",{className:"my-6",children:[e.jsx("img",{src:s,alt:o[1],className:"rounded-xl shadow-lg border border-black/10 dark:border-white/10 w-full max-w-3xl mx-auto"}),o[1]&&e.jsx("p",{className:"text-center text-sm text-custom-gray mt-2 italic",children:o[1]})]},`img-${a}`));return}if(t.startsWith("# ")){r.push(e.jsx("h1",{className:"text-4xl font-bold mt-8 mb-4 bg-clip-text text-transparent bg-gradient-to-r from-primary to-secondary inline-block",children:t.replace("# ","")},`h1-${a}`));return}if(t.startsWith("## ")){r.push(e.jsx("h2",{className:"text-2xl font-semibold mt-8 mb-4 flex items-center gap-2 pb-2 border-b border-border",children:t.replace("## ","")},`h2-${a}`));return}if(t.startsWith("### ")){r.push(e.jsx("h3",{className:"text-xl font-semibold mt-6 mb-2",children:t.replace("### ","")},`h3-${a}`));return}if(t.trim()==="---"){r.push(e.jsx("hr",{className:"my-8 border-border"},`hr-${a}`));return}if(t.trim().startsWith("- ")){const s=t.trim().substring(2);n.push(e.jsx("li",{className:"ml-4 pl-2 border-l-2 border-primary/50",children:m(s)},`li-${a}`));return}else n.length>0&&(r.push(e.jsx("ul",{className:"space-y-2 my-4 pl-4",children:[...n]},`ul-${a}`)),n=[]);t.trim()!==""&&r.push(e.jsx("p",{className:"leading-relaxed mb-4 text-custom-gray dark:text-zinc-300",children:m(t)},`p-${a}`))},m=t=>t.split(/(\*\*.*?\*\*|\*.*?\*|\[.*?\]\(.*?\)|`.*?`)/g).map((o,s)=>{if(o.startsWith("**")&&o.endsWith("**"))return e.jsx("strong",{className:"font-bold text-foreground",children:o.slice(2,-2)},s);if(o.startsWith("*")&&o.endsWith("*"))return e.jsx("em",{className:"italic",children:o.slice(1,-1)},s);if(o.startsWith("`")&&o.endsWith("`"))return e.jsx("code",{className:"px-1.5 py-0.5 rounded bg-zinc-100 dark:bg-zinc-800 font-mono text-sm text-primary",children:o.slice(1,-1)},s);const i=o.match(/\[(.*?)\]\((.*?)\)/);if(i){const l=i[2].startsWith("http");return e.jsx("a",{href:i[2],className:"text-primary hover:underline underline-offset-4 decoration-primary/30",target:l?"_blank":void 0,rel:l?"noopener noreferrer":void 0,children:i[1]},s)}return o});return u.forEach((t,a)=>h(t,a)),n.length>0&&r.push(e.jsx("ul",{className:"space-y-2 my-4 pl-4",children:[...n]},"ul-last")),e.jsx("div",{className:"max-w-4xl mx-auto",children:r})};function k(){return e.jsxs("div",{className:"min-h-screen pt-24 pb-20 px-4",children:[e.jsxs(f,{children:[e.jsx("title",{children:"Documentação | Vitor.dev"}),e.jsx("meta",{name:"description",content:"Documentação oficial e detalhes técnicos do projeto Portfolio."})]}),e.jsxs("div",{className:"container-custom mx-auto",children:[e.jsx("div",{className:"mb-8",children:e.jsxs(b,{to:"/",className:"inline-flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors mb-6 group",children:[e.jsx(x,{size:20,className:"group-hover:-translate-x-1 transition-transform"}),"Voltar para Home"]})}),e.jsxs("div",{className:"mb-12 text-center",children:[e.jsx("span",{className:"inline-block py-1 px-3 rounded-full bg-primary/10 text-primary text-sm font-medium mb-4",children:"Docs"}),e.jsx("h1",{className:"text-4xl md:text-5xl font-bold mb-4",children:"Documentação do Projeto"}),e.jsx("p",{className:"text-xl text-custom-gray max-w-2xl mx-auto",children:"Visão geral técnica, instalação e guia de uso."})]}),e.jsx("div",{className:"bg-white/80 dark:bg-slate-900/80 backdrop-blur-md rounded-2xl p-8 md:p-12 shadow-xl border border-white/20",children:e.jsx(v,{content:g})})]})]})}export{k as default};
