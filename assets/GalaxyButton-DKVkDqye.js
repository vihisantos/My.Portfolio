import{j as r}from"./ui-qcFD9uuN.js";const i=({href:a,text:e,download:c})=>r.jsxs("div",{className:"galaxy-button-wrapper w-full",children:[r.jsx("style",{children:`
        .uiverse {
          --duration: 7s;
          --easing: linear;
        ...
        `}),r.jsx("a",{href:a,download:c,className:"no-underline block w-full",children:r.jsx("div",{className:"uiverse w-full",children:r.jsxs("div",{className:"wrapper",children:[r.jsx("span",{children:e}),r.jsx("div",{className:"circle circle-12"}),r.jsx("div",{className:"circle circle-11"}),r.jsx("div",{className:"circle circle-10"}),r.jsx("div",{className:"circle circle-9"}),r.jsx("div",{className:"circle circle-8"}),r.jsx("div",{className:"circle circle-7"}),r.jsx("div",{className:"circle circle-6"}),r.jsx("div",{className:"circle circle-5"}),r.jsx("div",{className:"circle circle-4"}),r.jsx("div",{className:"circle circle-3"}),r.jsx("div",{className:"circle circle-2"}),r.jsx("div",{className:"circle circle-1"})]})})})]});export{i as G};
