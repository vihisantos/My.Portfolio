...
For more information, see https://radix-ui.com/primitives/docs/components/${t.docsSlug}`;return c.useEffect(()=>{e&&(document.getElementById(e)||console.error(n))},[n,e]),null},no="DialogDescriptionWarning",ro=({contentRef:e,descriptionId:t})=>{const r=`Warning: Missing \`Description\` or \`aria-describedby={undefined}\` for {${ft(no).contentName}}.`;return c.useEffect(()=>{const o=e.current?.getAttribute("aria-describedby");t&&o&&(document.getElementById(t)||console.warn(r))},[r,e,t]),null},ya=Qe,ma=nt,ga=rt,ka=ot,Ea=ct,ba=it,wa=lt;export{ma as $,fo as A,io as B,Co as C,he as D,Ho as E,bo as F,jo as G,wo as H,Do as I,To as J,go as K,qo as L,Ko as M,Vo as N,Go as O,P,oa as Q,so as R,aa as S,ua as T,la as U,lo as V,Io as W,fa as X,uo as Y,ha as Z,ya as _,fe as a,ka as a0,wa as a1,Ea as a2,ba as a3,ga as a4,Lo as a5,So as a6,Eo as a7,Ro as a8,ao as a9,Jo as aa,na as ab,Zo as ac,da as ad,ra as ae,ko as af,_o as ag,Yo as ah,ca as ai,Wo as aj,Oo as ak,ta as al,Bo as am,Qo as an,$o as ao,zo as ap,ia as aq,vo as ar,Ft as b,kt as c,X as d,A as e,B as f,Fe as g,z as h,Mt as i,g as j,co as k,Xo as l,Mo as m,Ao as n,ea as o,Po as p,xo as q,No as r,mo as s,sa as t,T as u,po as v,ho as w,yo as x,Fo as y,Uo as z};
