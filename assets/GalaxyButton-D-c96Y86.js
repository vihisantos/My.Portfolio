import{j as r}from"./ui-qcFD9uuN.js";import{C as e}from"./UILibrary-jKg4juUW.js";import"./vendor-BZTSXe9S.js";import"./index-C62QZ5qW.js";import"./framer-Bz8kBvrX.js";import"./SEO-DpK4jZQ8.js";import"./Navigation-DpYtyM83.js";import"./input-CxvnM-0f.js";const a=`import React from 'react';
...
`;function x(){return r.jsx(e,{title:"Galaxy Button",code:a,className:"flex items-center justify-center p-12",children:r.jsxs("div",{className:"galaxy-button-wrapper",children:[r.jsx("style",{children:`
        .uiverse {
          --duration: 7s;
          --easing: linear;
          --c-color-1: rgba(255, 163, 26, 0.7);
        ...
        `}),r.jsx("button",{className:"uiverse",children:r.jsxs("div",{className:"wrapper",children:[r.jsx("span",{children:"Portfolio"}),r.jsx("div",{className:"circle circle-12"}),r.jsx("div",{className:"circle circle-11"}),r.jsx("div",{className:"circle circle-10"}),r.jsx("div",{className:"circle circle-9"}),r.jsx("div",{className:"circle circle-8"}),r.jsx("div",{className:"circle circle-7"}),r.jsx("div",{className:"circle circle-6"}),r.jsx("div",{className:"circle circle-5"}),r.jsx("div",{className:"circle circle-4"}),r.jsx("div",{className:"circle circle-3"}),r.jsx("div",{className:"circle circle-2"}),r.jsx("div",{className:"circle circle-1"})]})})]})})}function m(){return r.jsxs("div",{className:"galaxy-button-wrapper scale-[1.4]",children:[r.jsx("style",{children:`
        .uiverse {
        ...
        @keyframes circle-12 { 33% { transform: translate(56px, 0px) translateZ(0); } 66% { transform: translate(60px, -32px) translateZ(0); } }
            `}),r.jsx("button",{className:"uiverse",children:r.jsxs("div",{className:"wrapper",children:[r.jsx("span",{children:"Portfolio"}),r.jsx("div",{className:"circle circle-12"}),r.jsx("div",{className:"circle circle-11"}),r.jsx("div",{className:"circle circle-10"}),r.jsx("div",{className:"circle circle-9"}),r.jsx("div",{className:"circle circle-8"}),r.jsx("div",{className:"circle circle-7"}),r.jsx("div",{className:"circle circle-6"}),r.jsx("div",{className:"circle circle-5"}),r.jsx("div",{className:"circle circle-4"}),r.jsx("div",{className:"circle circle-3"}),r.jsx("div",{className:"circle circle-2"}),r.jsx("div",{className:"circle circle-1"})]})})]})}export{x as GalaxyButton,m as GalaxyButtonContent};
