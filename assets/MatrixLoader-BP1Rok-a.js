import{j as t}from"./ui-BpQ-T0JO.js";import{C as e}from"./UILibrary-DHVl_TGJ.js";import"./vendor-BZTSXe9S.js";import"./index-B-iZa3N5.js";import"./framer-DCobejFE.js";import"./SEO-yt4J-mc4.js";import"./Navigation-D_TMajI5.js";import"./input-B5WnmuMM.js";import"./index-C8pce-KX.js";const r=`import React from 'react';
...
`;function o(){const n=Array(200).fill("アイウエオカキクケコサシスセソタチツテトナニヌネノハヒフヘホマミムメモヤユヨラリルレロワヲンガギグゲゴザジズゼゾダヂヅデドバビブベボパピプペポ").join("");return t.jsxs("div",{className:"matrix-loader-wrapper w-full h-full absolute inset-0",children:[t.jsx("style",{children:`
            ...
            `}),t.jsx("div",{className:"matrix-container",children:n.split("").map((a,i)=>t.jsx("span",{children:a},i))})]})}function g(){return t.jsx(e,{title:"Matrix Loader",code:r,className:"min-h-[300px] flex items-center justify-center overflow-hidden",children:t.jsx(o,{})})}export{g as MatrixLoader,o as MatrixLoaderContent};
