...
export function SparkleSwitch() {
    return (
        <ComponentShowcase title="Sparkle Switch" code={code} className="flex items-center justify-center p-12 min-h-[300px]">
            <div className="sparkle-switch-wrapper">
                <style>
                    {`
        .sparkle-switch-wrapper .sparkle-toggle-cont {
        ...
        `}
                ...
                <div className="sparkle-toggle-cont">
                    <input className="sparkle-toggle-input" id="sparkle-toggle-demo" name="sparkle-toggle" type="checkbox" />
                    <label className="sparkle-toggle-label" htmlFor="sparkle-toggle-demo">
                        <div className="sparkle-cont-icon">
                            {[
                                { w: 2, d: 25, t: 11 }, { w: 1, d: 100, t: 18 }, { w: 1, d: 280, t: 5 },
                                { w: 2, d: 200, t: 3 }, { w: 2, d: 30, t: 20 }, { w: 2, d: 300, t: 9 },
